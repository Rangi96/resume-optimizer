      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        <div className="bg-white rounded-xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2 text-gray-700">
              <li><strong>10 Exports Package:</strong> $9.00 USD - Includes 10 PDF/HTML/JSON exports</li>
              <li><strong>20 Exports Package:</strong> $16.00 USD - Includes 20 PDF/HTML/JSON exports</li>
            </ul>
